...
[[noreturn]] int main()
{
    ...
    auto[plane_indices, plane_vertices] = geometry_generators::generate_rectangle_geometry_data(500.0f, 500.0f, 10, 10);
    ...
    auto[lamp_indices, lamp_vertices] = geometry_generators::generate_sphere_geometry_data(0.1f, 20, 20);
    ...
    float point_light_radius1 = 4.0f;
    float point_light_radius2 = 4.5f;
