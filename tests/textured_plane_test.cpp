...
[[noreturn]] int main()
{
    ...
    auto[plane1_indices, plane1_vertices] = geometry_generators::generate_rectangle_geometry_data(5, 3, 2, 2);
    ...
    auto[plane2_indices, plane2_vertices] = geometry_generators::generate_rectangle_geometry_data(100, 100, 2, 2);
