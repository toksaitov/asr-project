...
[[noreturn]] int main()
{
    ...
    auto[plane1_indices, plane1_vertices] = geometry_generators::generate_rectangle_geometry_data(40, 40, 1, 1);
    ...
    plane1_material->set_diffuse_color(glm::vec4(0.8f, 0.27f, 0.21f, 1.0f));
